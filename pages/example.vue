  ...
  <div>
        ...
        >
          ...
          >
            ...
            >
              <span
                x-show="hover"
                class="absolute inset-0 inline-block w-full h-1 md:h-full transform bg-gray-900"
      ...
      >
        <div class="flex flex-col items-center sm:px-5 md:flex-row">
          ...
          >
            ...
            >
              <div
                class="bg-pink-500 flex items-center pl-2 pr-3 py-1.5 leading-none rounded-full text-xs font-medium uppercase text-white lg:inline-block"
              >
                <svg
        ...
        <div class="grid grid-cols-12 pb-10 sm:px-5 gap-x-8 gap-y-16">
          ...
          >
            ...
            <div
              class="bg-purple-500 flex items-center px-3 py-1.5 leading-none rounded-full text-xs font-medium uppercase text-white lg:inline-block"
            >
              <span>Lifestyle</span>
            </div>
          ...
          >
            ...
            <div
              class="bg-pink-500 flex items-center px-3 py-1.5 leading-none rounded-full text-xs font-medium uppercase text-white lg:inline-block"
            >
              <span>Health</span>
            </div>
            <h2 class="text-lg font-bold sm:text-xl md:text-2xl">
          ...
          >
            ...
            <div
              class="bg-red-500 flex items-center px-3 py-1.5 leading-none rounded-full text-xs font-medium uppercase text-white lg:inline-block"
            >
              <span>Food</span>
            </div>
            <h2 class="text-lg font-bold sm:text-xl md:text-2xl">
          ...
          >
            ...
            <div
              class="bg-blue-500 flex items-center px-3 py-1.5 leading-none rounded-full text-xs font-medium uppercase text-white lg:inline-block"
            >
          ...
          >
            ...
            <div
              class="bg-gray-800 flex items-center px-3 py-1.5 leading-none rounded-full text-xs font-medium uppercase text-white lg:inline-block"
            >
              <span>Business</span>
            </div>
            <h2 class="text-lg font-bold sm:text-xl md:text-2xl">
          ...
          >
            ...
            <div
              class="bg-yellow-400 flex items-center px-3 py-1.5 leading-none rounded-full text-xs font-medium uppercase text-white lg:inline-block"
            >
              <span>Nutrition</span>
            </div>
            <h2 class="text-lg font-bold sm:text-xl md:text-2xl">
    ...
    <section class="bg-white pt-7 pb-14">
      <div class="container px-8 mx-auto sm:px-12 lg:px-20">
        ...
        <div
          class="flex sm:grid items-center justify-center md:grid-cols-4 lg:grid-cols-12 gap-y-8"
        >
          <div
